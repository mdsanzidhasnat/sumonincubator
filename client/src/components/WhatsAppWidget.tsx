  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      {isOpen && (
        <div className="mb-3 w-[calc(100vw-3rem)] max-w-xs bg-white rounded-lg shadow-2xl border border-bismillah-borderLight overflow-hidden animate-in slide-in-from-bottom-4 duration-200">
          ...
          <div className="p-3 bg-slate-50 space-y-2 text-xs">
            <div className="bg-white p-2.5 rounded-lg border border-bismillah-borderLight text-slate-800">
              <p className="font-bold text-bismillah-primaryGreen">আসসালামু আলাইকুম! 👋</p>
            ...
            <textarea
              ...
              className="w-full bg-white border border-slate-300 rounded-lg p-2 outline-none text-slate-800 focus:border-emerald-600"
            />

            <button
              onClick={handleSend}
              className="w-full bg-bismillah-primaryGreen hover:bg-emerald-700 text-white font-bold py-2 rounded-lg flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
            >
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-bismillah-primaryGreen hover:bg-emerald-700 text-white shadow-xl flex items-center justify-center cursor-pointer transform hover:scale-110 transition-all border-2 border-white"
